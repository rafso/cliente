...
if ($account || $_GET["ref"])
{
	...
	//verifica se é para filtrar pelo subcentro
...
//	print utf8_encode('<td><div id="div1" style="display:block;"><select name="subcentro1" id="subcentro1"><option value="0"></option><option value="1">Fichados</option><option value="2">Medição</option></select></div>');
//	print utf8_encode('<div id="div2" style="display:none;"><select name="subcentro2"  id="subcentro2"><option value="0"></option><option value="3">Acabamentos</option><option value="4">Material básico</option><option value="5">Material elétrico</option><option value="6">Material hidráulico</option><option value="7">Esquadrias</option><option value="8">Impermeabialização</option></select></div>');
//	print utf8_encode('<div id="div3" style="display:none;"><select name="subcentro3" id="subcentro3"><option value="0"></option><option value="9">Aquisição</option><option value="10">Locação</option><option value="11">Manutenção</option></select></div></td>');
...
//    }
    ...
    $sql.= " WHERE b.fk_account=".$acct->id;
    $sql.= " AND b.fk_account = ba.rowid";
	//verifica se é para filtrar pela origem

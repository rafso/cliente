...
$sql.= " bu.label as labelurl, bu.url_id, b.origem";
$sql.= " FROM ";
...
if ($resql)
{
	...
	print '<td class="liste_titre">'.$langs->trans("origem").'</td>';
	...
	print '</td>';
    print '<td class="liste_titre"><input type="text" class="flat" name="origem" value="'. $origem .'" size="14" maxlength="190"></td>';

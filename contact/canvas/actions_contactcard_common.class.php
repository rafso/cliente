...
class ActionsContactCardCommon
{
    ...
    function assign_values($action='')
    {
        ...
        if ($action == 'create' || $action == 'edit')
        {
			...
			$this->tpl['select_visibility'] = 0; //era: $form->selectarray('priv',$selectarray,$this->object->priv,0);
        }
        ...
        if ($action == 'view')
        {
			...
			$this->tpl['visibility'] = $this->object->LibPubPriv(0); //ao invés de 0 era $this->object->priv

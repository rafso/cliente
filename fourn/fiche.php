...
//$result = restrictedArea($user, 'societe',$socid,'');  //retirado para a pessoa poder ver os dados do fornecedor mesmo sem permissão específica, tendo permissão de fornecedores ela poderá ver os fornecedores
...
if ( $societe->fetch($socid) )
{
	...
	print '<tr><td valign="top" width="1%" class="notopnoleft">';

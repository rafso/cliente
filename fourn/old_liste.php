...
$sql = "SELECT s.rowid as socid, s.nom, s.como_conheceu, s.idprof4, s.datec, s.datea,  st.libelle as stcomm, s.prefix_comm, s.status as status, ";
...
if ($search_ville) $sql .= " AND s.como_conheceu LIKE '%".$db->escape($search_ville)."%'";
...
if ($resql)
{
	...
	print_liste_field_titre($langs->trans("TipoFW"),$_SERVER["PHP_SELF"],"s.como_conheceu","",$param,'align="left"',$sortfield,$sortorder);
...
//	print '</td>';
	...
	while ($i < min($num,$conf->liste_limit))
	{
		...
		print '<td align="left">'.$obj->como_conheceu.'&nbsp;</td>';

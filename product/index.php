 ...
 */
//redireciona para a página de listagem de requisições ao invés de tela principal
header('Location: /product/liste.php?leftmenu=service&type=1'); //era /cliente/product/liste.php?leftmenu=service&type=1
